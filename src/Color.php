...
class Color
{
     ...
     */
    public function __construct(protected int $red = 0, protected int $green = 0, protected int $blue = 0, protected int|null $alpha = null)
    {
    }
    ...
    public function getIndex(\GdImage $image): int|false
    {
        $index = $this->hasAlphaChannel()
            ? imagecolorexactalpha($image, $this->red, $this->green, $this->blue, $this->alpha)
            : imagecolorexact($image, $this->red, $this->green, $this->blue);
        ...
        return $this->hasAlphaChannel()
            ? imagecolorallocatealpha($image, $this->red, $this->green, $this->blue, $this->alpha)
            : imagecolorallocate($image, $this->red, $this->green, $this->blue);
    }
